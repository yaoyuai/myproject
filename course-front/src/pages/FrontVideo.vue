<template>
	<div class="video-cls">
		...
		<el-table :data="videoInfoList" stripe style="margin-left: 5%; margin-right: 10%; width:80%;">
			...
			<el-table-column prop="materialId" label="视频编号">
			</el-table-column>
			<el-table-column prop="materialName" label="视频名称">
			</el-table-column>
			...
			<el-table-column label="操作">
				<template slot-scope="scope">
					<el-tooltip class="item" effect="dark" content="学习" placement="top-start">
						<el-button type="success" icon="el-icon-video-camera-solid" circle @click="showFile(scope.$index, scope.row)">
						</el-button>
					</el-tooltip>
					</template>
			</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getVideoList(){
				...
				axios.post("/material/getvideoinfo",{"teacherId":obj.teacherId,"courseId":obj.courseId,"nowPage":(this.nowPage-1)*this.divideNum,"divideNum":this.divideNum}).then((resp)=>{
